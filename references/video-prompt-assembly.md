...
约束：场景一致性参考@图0（悬崖/乌云/闪电/环境光跨帧不变）。首尾帧动作锚点参考@图1（帧1背影蓄力→帧7正面沉稳定格，人物动作不漂移）。角色面部/服装/武器参考@图2不可变。画面锚点参考@图3-5不偏离。运镜/景别/焦段/色彩/灯光/转场/时长严格按故事板执行。台词：帧7口型同步「所有人感受。」沉稳语气不眯眼。字幕：帧7底部中央「所有人感受。」

风格：VS5 暴力美学，8K，cinematic 15s，no watermark，no broken faces。
```
