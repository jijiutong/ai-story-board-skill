...
| # | 检查项 | 满分 | 扣分规则 |
|---|--------|------|---------|
| V1 | **@图 引用完整性** | 25 | 视频 prompt 引用 @图 未在 asset-map 声明 → -20/处 |
| V2 | **平台参数合规** | 25 | 字数/参考图/时长超平台限制 → -20/项 |
| V3 | **运镜可执行性** | 25 | 狭小空间使用禁止运镜（R005）→ -20/处 |
| V4 | **动作物理合理** | 25 | 运动预算超限或方向冲突（motion-physics 检查）→ -15/处 |
