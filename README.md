...
```
═══════════════════════════════════════════════════════════════════════
                     AI VISUAL DIRECTOR — 完整管线
═══════════════════════════════════════════════════════════════════════

输入层            分析层              视觉层             分镜层             输出层              扩展层
┌──────────┐  ┌────────────┐  ┌──────────────┐  ┌────────────┐  ┌────────────┐  ┌────────────┐
│ 🎬 一键   │  │ 📐 三幕    │  │ 🎨 32种视觉  │  │ 📋 10种    │  │ 🔄 多版本  │  │ 🎬 视频    │
│   工作流  │→│   结构分析 │→│   风格引擎   │→│   输出格式 │→│   A/B/C对比│→│   适配引擎 │
│          │  │            │  │              │  │            │  │            │  │            │
│ 📦 批量   │  │ 📈 情绪    │  │ 🔀 风格融合  │  │ 🎞️ 5种    │  │ 📦 批量    │  │ 🎵 音乐    │
│   章节    │→│   曲线驱动 │→│   60%+40%    │→│   节奏模式 │→│   模式     │→│   SFX参考  │
│   处理    │  │            │  │   智能混合   │  │            │  │            │  │            │
│          │  │            │  │              │  │            │  │            │  │            │
│ 🖼️ 缩略  │  │ 💕 角色    │  │ 🎚️ Mood     │  │ ✏️ 单镜    │  │ 📐 多画幅  │  │ 📤 行业    │
│   速出    │→│   关系15种 │→│   10维滑块   │→│   精准修改 │→│   6比例    │→│   格式导出 │
│   模式    │  │            │  │              │  │            │  │            │  │            │
│          │  │            │  │              │  │            │  │            │  │            │
│ ⭐ Prompt │  │ 🌍 文化    │  │ 🌈 色彩      │  │ 🔍 连续性  │  │ 📝 版本    │  │ 🎭 导演    │
│   评分器  │→│   精准规则 │→│   叙事引擎   │→│   5维检查  │→│   管理系统 │→│   阐述     │
│          │  │            │  │              │  │            │  │            │  │            │
│          │  │            │  │ 🧬 角色DNA   │  │            │  │ 🔄 风格    │  │            │
│          │  │            │  │   13字段锁定 │  │            │  │   迁移     │  │            │
│          │  │            │  │              │  │            │  │            │  │            │
...
└────┬─────┘  └─────┬──────┘  └──────┬───────┘  └─────┬──────┘  └─────┬──────┘  └────────────┘
     ...
     └──────────────┴───────────────┴───────────────┴───────────────┘
                    ...
                    ╔══════════════════════════════════╗
                    ║  📱 多平台输出引擎               ║
                    ║  GPT Image 2 │ Midjourney v6    ║
                    ║  SD XL │ Sora │ Runway │ 可灵  ║
                    ╚══════════════════════════════════╝

30 项核心能力 × 34 个参考文件 × 6 大平台适配
═══════════════════════════════════════════════════════════════════════
```
